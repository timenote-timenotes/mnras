...
\subsection{\added{Color-aperture Dependence}}
\comment{This part is newly added}
Cometary colors may vary with photometric aperture, and numerous studies have explored this dependence (e.g., \citealt{betzler_analysis_2017, kolokolova_color_2003}). In order to maximize the color differences with apertures, the $\mathrm{B-R}$ color is well-suited for analysis \citep{jewittCOLORSYSTEMATICSCOMETS2015}. For this purpose, the $\mathrm{B-R}$ color of the two comets is additionally measured with variable apertures, and some of the results are shown in Fig.~\ref{fig:color-aper}. Linear regression on the $\mathrm{B-R}$-aperture region is performed around \qty{40000}{\km}, and the slope of the fitting line (blue dashed line in the figure) is used to quantify the $\mathrm{B-R}$ color variation. The fitting errors are all omitted since they are negligible. Table~\ref{tab:color-variation} lists the $\mathrm{B-R}$ color variation in units of [\unit{mag/\qty{e4}{\km}}] for comets C/2019 L3 and C/2020 P3. The $\mathrm{B-R}$ color variations for comet C/2019 L3 are very small, with an average value of \qty{-8.93e-3}{mag/\qty{e4}{\km}}.  



In most cases, the $\mathrm{B-R}$ color becomes bluer as the aperture size increases for comet C/2019 L3. While on \DTMdate{2021-4-4}, \DTMdate{2021-5-4} and \DTMdate{2021-5-14}, 
...
\begin{table}
    \centering
    \caption{Average $\mathrm{B-R}$ color variations around photometric aperture for comets C/2019 L3 (ATLAS) and C/2020 P3 (ATLAS).}\label{tab:color-variation}
