...
\begin{table}
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{ccccccccccc}
            \toprule
            Observation Date & r~[\si{\astronomicalunit}]\tnote{1} & $\Delta$~[\si{\astronomicalunit}]\tnote{2} & Ph.A\tnote{3} & Filters\tnote{4} & Size\tnote{5} & \added{Bin} & \added{Seeing [\unit{\arcsecond}]} & \added{SNR} & Scale~[\si{\km/px}]\tnote{6} & Telescope \\
            \midrule
