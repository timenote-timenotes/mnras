...
\begin{table}
    ...
    \begin{threeparttable}
        ...
        \begin{tablenotes}
            ...
            \item[7] \ul{images on this date are too faint to use}
        \end{tablenotes}
    \end{threeparttable}
\end{table}
