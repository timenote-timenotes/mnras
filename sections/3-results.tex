...
\begin{table}
    \centering
    \caption{Photometric results of comets C/2019 L3 and C/2020 P3. }\label{tab:bvr}
...
\begin{table}
    \centering
    \caption{$Af\rho$ values for comets C/2019 L3 and C/2020 P3. }\label{tab:afrho}
    \begin{threeparttable}
        \resizebox{\linewidth}{!}{
        \begin{tabular}{cccc}
            \toprule
...
\begin{table}
    \centering
    \caption{Reddening of comets C/2019 L3 and C/2020 P3 with $\rho = $ \qty{2e4}{\km}. }\label{tab:reddening}
    \begin{threeparttable}
        \resizebox{\linewidth}{!}{
        \begin{tabular}{cccc}
            \toprule
