...
Due to the phase darkening effect, it is necessary to adjust $Af\rho$ values at different phase angles to a specific angle. In this work, all observations were conducted at small phase angles, and we normalize the $Af\rho$ values to a phase angle of \ang{0} using equation (\ref{eq:a0frho}), as is shown below:
\begin{equation}
...
\begin{figure}
    ...
    % }
    \subcaptionbox{R-band $A(0)f\rho$ of comet C/2019 L3}{
        \includegraphics[width=\columnwidth]{R-A0frho-C2019L3-210514-119.pdf}
    }

    \subcaptionbox{R-band $A(0)f\rho$ of comet C/2020 P3}{
        \includegraphics[width=\columnwidth]{R-A0frho-C2020P3-210402.pdf}
    }
    % \subcaptionbox{}{
...
\begin{figure}
    ...
    \caption{The reddening of comet C/2019 L3 with date, blue dashed line is the averaged reddening, \ul{and the surounding red shadow shows the error}. }\label{fig:reddening}
\end{figure}
