...
\begin{table}
    \centering
    \caption{Photometric results of comets C/2019 L3 (ATLAS) and C/2020 P3 (ATLAS) with apertures consistently set to \added{a radius of} \qty{40000}{\km}. }\label{tab:bvr}
...
\begin{table}
    \centering
    \caption{$A(0)f\rho$ values for comets C/2019 L3 (ATLAS) and C/2020 P3 (ATLAS) \added{within the aperture radius} $\rho = \qty{10000}{\km}$. }\label{tab:afrho}
    \begin{threeparttable}
        % \resizebox{\linewidth}{!}{
        \begin{tabular}{cc}
            \toprule
...
\label{eq:red}
\end{equation}
where $\lambda_1$ and $\lambda_2$ are the central wavelengths of the filters in units of [\unit{\nm}] (respectively the centers of B and R filters, {\qty{440}{\nm}} and {\qty{658}{\nm}}). With this parameter it is convenient to indicate the percentage of change in the strength of the continuum per {\qty{1000}{\angstrom}}. The results of dust reddening are summarised in Table~\ref{tab:reddening}. In order to avoid the possible effects from background residuals, it is calculated \added{within the aperture radius of} {\qty{20000}{\km}}. 
...
\begin{table}
    \centering
    \caption{Reddening of comets C/2019 L3 (ATLAS) and C/2020 P3 (ATLAS) \added{within the aperture radius} $\rho = \qty{20000}{\km}$. }\label{tab:reddening}
    \begin{threeparttable}
        \resizebox{\linewidth}{!}{
        \begin{tabular}{cccc}
            \toprule
...
\begin{figure}
    ...
    \caption{The reddening of comet C/2019 L3 (ATLAS) with date, blue dashed line is the averaged reddening, and the surounding red shadow shows the error. }\label{fig:reddening}
\end{figure}
