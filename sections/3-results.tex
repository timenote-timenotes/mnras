...
Based on the photometric results, the radial surface brightness profile (SBP) was computed as the function of the angular distance $\rho$ measured from the photocenter of comet. The measurement of surface brightness is largely affected by the accuracy of \replaced{background}{bakground} \replaced{subtraction}{substraction}. In order to obtain an accurate estimate of the background, we use the \texttt{photutils} package in Python and generate a 2D image of the background. 
...
\begin{figure}
    ...
    \caption{The reddening of comet C/2019 L3 (ATLAS) with date, blue dashed line is the averaged reddening, and the \replaced{surrounding}{surounding} red shadow shows the error. }\label{fig:reddening}
\end{figure}
