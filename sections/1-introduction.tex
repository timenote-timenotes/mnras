...
Long-period comets also exhibit activity at large heliocentric distances more than {\qty{5}{\astronomicalunit}} \added{(e.g., \mbox{\citealt{mazzotta_epifani_distant_2009, mazzotta_epifani_activity_2010}}; \mbox{\citealt{meech_activity_2009}}; \mbox{\citealt{ivanova_quasi-simultaneous_2023}})}, \replaced{in which case }{At this time, }the activity is not caused by the sublimation effect of water ice. The current explanation about distant activity of comets mainly includes: the phase transition between amorphous and crystalline water ice~\citep{prialnik_crystallization_1992, capria_c1995_2002}, the annealing of amorphous water ice \citep{meech_activity_2009}, and the sublimation of more volatile components such as \ce{CO2}~\citep{ootsubo_akari_2012} and/or \ce{CO}~\citep{jewitt_distant_2019}. 
