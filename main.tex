...
\begin{abstract}
	The observational results for two Long-period comets, namely C/2019 L3 and C/2020 P3, are analyzed in this paper. 
	...
	We study the morphology, surface brightness, $Af\rho$ values as well as coma colors of the two comets based on these data. 
\end{abstract}
